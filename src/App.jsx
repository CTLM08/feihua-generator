...
export const App = () => {
  ...
  function problem(){
     ...
     if(chose==3){
      ...
      setparagraph(`${subject2}到底是怎么回事？得知真相后大家都蒙圈了小编认为，这一定是还有其他原因的。${subject2}${bruh}，其实就是${explain}，大家可能会很惊讶${subject2}怎么会${bruh}呢？但事实就是这样，小编也感到非常惊讶。这就是关于${subject2}${bruh}的事情了，大家有什么想法呢，欢迎在评论区告诉小编一起讨论哦`)
      if(subject2==""||burh==""||explain==""){
        setparagraph("请输入内容,谢谢")
      }
    }
  }
  ...
  return (
    <div className="bg-slate-200 h-screen w-full flex items-center flex-row justify-center gap-4 md:gap-12 relative p-2 md:p-0">
      <div className="z-[999] animate__animated animate__lightSpeedInLeft ">
        <div className="text-xl md:text-3xl ">废话生成器</div>
        <div className="mt-5 ">
          <>
            {chose == 2 ? (
              <>
      ...
      <div className="bg-white w-48 md:w-96  ans  rounded-xl p-3 z-[99] relative animate__animated animate__lightSpeedInRight">
      ...
      <div className="">
        <Icon
          ...
          className=" -left-12 md:-left-16 w-56 h-56 md:w-96 md:h-96 absolute top-2 md:-top-16 text-slate-300 hover:animate-spin"
        />
      </div>
      <div className="container absolute bottom-2 ">
        <h1>made by liming..</h1>{" "}
      </div>
    </div>
  );
};
